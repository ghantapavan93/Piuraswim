...
export function CampaignHero() {
  return (
    <section className="campaign-hero under-header" aria-labelledby="hero-title">
      <AmbientVideo
      ...
      />
      <div className="campaign-hero__scrim" aria-hidden="true" />

      <div className="campaign-hero__meta container">
        <p className="label">{HERO.eyebrow}</p>
        <p className="campaign-hero__coordinates label">{BRAND.coordinates}</p>
      </div>

      <div className="campaign-hero__content container">
        <h1 id="hero-title" className="campaign-hero__title display display-xl">
          {HERO.title[0]}
          <br />
          <em>{HERO.title[1]}</em>
        </h1>
        <p className="campaign-hero__body">{HERO.body}</p>
        <div className="campaign-hero__actions">
          <Link href={HERO.primary.href} className="button button-light">
            {HERO.primary.label}
            <Icon name="arrow" />
          </Link>
          <Link href={HERO.secondary.href} className="campaign-hero__secondary text-link">
      ...
      <p className="campaign-hero__scroll-hint" aria-hidden="true">
